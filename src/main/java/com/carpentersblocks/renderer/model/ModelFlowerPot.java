...
public class ModelFlowerPot implements IModel 
{ 
    @Override
    ...
    {
        return ImmutableSet.of(new ResourceLocation( MOD_ID, "blocks/general/solid"), new ResourceLocation("minecraft", "blocks/dirt"));
    }
